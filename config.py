...
# ── Core bot config ────────────────────────────────────────────────────────────
API_ID = int(getenv("API_ID", 23264133))
API_HASH = getenv("API_HASH", "945e5b76ce8550bebbeeaf5599e7ce58")
BOT_TOKEN = getenv("BOT_TOKEN")

OWNER_ID = int(getenv("OWNER_ID", 6883111123))
OWNER_USERNAME = getenv("OWNER_USERNAME", "Eren_Yeager_76")
BOT_USERNAME = getenv("BOT_USERNAME", "AB_VERSE_MUSIC_BOT")
BOT_NAME = getenv("BOT_NAME", "AB VERSE MUSIC BOT")
ASSUSERNAME = getenv("ASSUSERNAME", "˹Kaneki")

# ── Database & logging ─────────────────────────────────────────────────────────
MONGO_DB_URI = getenv("MONGO_DB_URI")
LOGGER_ID = int(getenv("LOGGER_ID", -1003533680480))
